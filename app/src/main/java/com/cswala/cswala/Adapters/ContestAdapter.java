...
public class ContestAdapter extends RecyclerView.Adapter<ContestAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.contest_url.setText(resultList.getUrl());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(resultList.getUrl()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView contest_name, contest_url, contest_start_time, contest_end_time, contest_duration, contest_status;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            contest_name = itemView.findViewById(R.id.contest_name);
            contest_url = itemView.findViewById(R.id.contest_url);
